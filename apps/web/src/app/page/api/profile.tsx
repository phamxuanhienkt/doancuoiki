          ...
          <div className="flex flex-col space-y-4 w-full">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                onClick={() =>
                  openModal("Edit Full Name", profile.fullName, "fullName")
                }
              >
                <CiEdit size={20} />
              </button>
            ...
            <div className="flex justify-between items-center">
              ...
              <button
                className="text-purple-500 hover:text-purple-700"
                onClick={() => openModal("Edit Phone", profile.phone, "phone")}
              >
                <CiEdit size={20} />
              </button>
            </div>
            <div className="flex justify-between items-center">
              ...
              <button
                className="text-purple-500 hover:text-purple-700"
                onClick={() =>
                  openModal("Edit Account", profile.account, "account")
                }
              >
                <CiEdit size={20} />
              </button>
            ...
            <div className="flex justify-between items-center">
              <div className="text-xl font-bold text-blue-800">
                Watch Time: {profile.watchTime}
              </div>
              <button
                className="text-purple-500 hover:text-purple-700"
                onClick={() =>
                  openModal("Edit Watch Time", profile.watchTime, "watchTime")
                }
              >
                <CiEdit size={20} />
              </button>
            ...
            <div className="flex flex-col space-y-1">
              <div className="flex justify-between items-center">
                ...
                <button
                  className="text-purple-500 hover:text-purple-700"
                  onClick={() =>
                    openModal("Edit Earnings", profile.earnings, "earnings")
                  }
                >
                  <CiEdit size={20} />
                </button>
